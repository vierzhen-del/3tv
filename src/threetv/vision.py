...
- 광고: 화면 전체가 상품/서비스 홍보, 협찬, 구독 유도인 경우 → text는 상품명만 간단히
  ⚠️ **ETF는 전부 광고로 분류하세요.** 삼프로TV는 시황 방송에서 ETF를 분석 대상으로
  다루지 않고, 화면의 ETF는 예외 없이 협찬·상품 홍보입니다.
  (KODEX·TIGER·ACE·PLUS·SOL·KBSTAR·ARIRANG·HANARO·KOSEF·TIMEFOLIO·RISE·BNK 등
   운용사 브랜드가 붙은 종목, 그리고 이름에 'ETF'·'커버드콜'·'인버스'·'레버리지'가
   들어간 종목) → type은 "광고", stocks에도 넣지 마세요.
