...
2) 💹 주요 지표 — 각 항목마다 **종가 + 전일대비 등락률(▲/▼) + 종가 기준일**을 명시:
   - 3대 지수: 다우존스 / S&P500 / 나스닥
   - 반도체: 필라델피아 반도체지수(SOX) / SOXL
   - 금리·달러: 미국채 10년물·5년물 / 달러인덱스
   - 원자재·환율: WTI 원유 / 금 / 원-달러 환율
   - 변동성: VIX
3) 🚀 M7 종목별 등락 표: 애플·마이크로소프트·알파벳·아마존·엔비디아·메타·테슬라
   (종목 | 종가 | 전일대비 | 기준일)
4) 📈 방송에서 언급된 그 외 미국 종목: 종목 | 종가 | 전일대비
5) 🇰🇷 **오늘 국내 증시 전망** (필수 섹션) — 위 미국장 결과를 근거로:
   - KOSPI·KOSDAQ 예상 방향(상승/하락/보합 압력)과 그 근거
